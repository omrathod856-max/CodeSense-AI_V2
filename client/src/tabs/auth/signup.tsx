  ...
  return (
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#0d1117] text-[#e6edf3] font-sans px-4">
      ...
      <div className="mb-8 flex flex-col items-center">
        <h1 className="text-2xl font-light tracking-tight">Sign up for CodeSense</h1>
      </div>
      ...
      <Card className="w-full max-w-85 p-5 bg-[#161b22] border-[#30363d] rounded-md shadow-none">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            <label className="text-sm font-normal text-[#e6edf3]">Username</label>
            <Input
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              ...
              {/* <Link to="/forgot-password" className="text-xs text-[#2f81f7] hover:underline">
                Forgot password?
              </Link> */}
            </div>
            <Input
      ...
      <div className="w-full max-w-85 mt-4 p-4 border border-[#30363d] rounded-md text-center text-sm">
        ...
        <Link to="/" className="text-[#2f81f7] hover:underline">
